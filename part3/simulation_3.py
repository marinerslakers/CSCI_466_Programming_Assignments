...
if __name__ == '__main__':
    ...
    #add all the links - need to reflect the connectivity in cost_D tables above(has all the above new routers added)
    ...
    host_2.udt_send('H1', 'MESSAGE_FROM_H2') #added to send a message back
    sleep(simulation_time)
